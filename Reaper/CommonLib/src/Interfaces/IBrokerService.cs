...
{
    Task<Result<string>> BuyLimitAsync(string symbol, decimal amount, CancellationToken cancellationToken);
    Task<Result<string>> BuyMarketAsync(string symbol, decimal amount, CancellationToken cancellationToken);
    Task<Result<string>> SellLimitAsync(string symbol, decimal amount, CancellationToken cancellationToken);
